...
> **EJEMPLO ILUSTRATIVO** — Este archivo es un ejemplo mock para mostrar cómo debe lucir el output de `documentation.QATesting`. No corresponde a una sesión real ni a un feature real. La estructura canónica está en `analysis-report-template.md`; este archivo es referencial.
...
**Correlation ID:** 3f2a1b8c-d4e5-4f6a-9b7c-1a2b3c4d5e6f.documentation.QATesting.1
