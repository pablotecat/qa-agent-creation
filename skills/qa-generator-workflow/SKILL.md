...
Tras cerrar cada paso, documenta una fila en `QA.generator-work-log.md` siguiendo la plantilla canónica en `references/work-log-template.md` (formato único; no uses otro).
