...
description: Workflow del agente QA.documentation para extraer, normalizar y entregar requisitos con handoff.
...
Workflow para `QA.documentation`: extrae, normaliza y entrega requisitos con handoff. El flujo operativo se divide en archivos bajo `./steps/`. DEBES seguir la secuencia de pasos y las reglas de cada uno.
