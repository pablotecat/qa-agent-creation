...
1. DEBES ejecutar esta skill: `.github/skills/qa-planner-workflow/SKILL.md`, pasándole `to <output_dir>` donde `<output_dir>` es `./tests/Documentation/sessions/session_{N}_{id}/QA-planner-agent/` siguiendo la gestión de sesión del `QATesting-general.instructions.md`.
